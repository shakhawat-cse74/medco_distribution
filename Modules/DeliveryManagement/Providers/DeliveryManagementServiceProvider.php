...
class DeliveryManagementServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        if (class_exists(\Modules\DeliveryManagement\Providers\RouteServiceProvider::class)) {
            $this->app->register(\Modules\DeliveryManagement\Providers\RouteServiceProvider::class);
        }
    }
