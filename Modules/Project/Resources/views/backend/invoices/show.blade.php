    ...
    <div class="col-md-12 p-3">
        ...
        <div class="col-md-3 p-3">
            <button id="print-btn" type="button" class="btn btn-default btn-sm d-print-none"><i
                        class="ti ti-printer"></i> {{trans('file.Print')}}</button>
        </div>
...
<script>
    (function($) {
        ...
        $("#print-btn").on("click", function () {
            ...
            newWin.document.write('<link rel="stylesheet" href="{{ asset($asset_prefix . 'vendor/bootstrap/css/bootstrap.min.css') }}" type="text/css"><style type="text/css">@media print {.invoice_details { max-width:100%;} }</style><body onload="window.print()">' + divToPrint.innerHTML + '</body>');
