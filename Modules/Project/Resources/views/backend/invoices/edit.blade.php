                        ...
                        <div class="form-group overflow-hidden1">
                            <div class="col-xs-12">
                                <button type="button" data-repeater-edit="" class="btn btn-primary"
                                        id="add-invoice-item"><i class="ti ti-plus"></i> {{__('Add Item')}}
                                </button>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-5 col-sm-12 text-xs-center">
                                    <button type="submit" name="invoice_submit" class="btn btn-primary pull-right my-1 mr-3"><i
                                                class="ti ti fa-check-square-o"></i>{{__('Submit Invoice')}}</button>
                                </div>
                            </div>
                        </div>
                    </form>
...
<script type="text/javascript" src="{{ asset($asset_prefix . 'js/compiled_from_ts/invoice-edit.js') }}"></script>
@endpush
