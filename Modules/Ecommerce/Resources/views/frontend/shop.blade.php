            ...
            <div class="product-grid mar-bot-30 row">
                ...
                <div class="col-sm-2 text-center mt-3">
                    <a href="{{ url('/shop') }}/{{$cat->slug}}">
                        ...
                        @else
                            <img loading="lazy" src="https://dummyimage.com/100x100/e5e8ec/333333&text={{ urlencode($cat->name) }}" alt="{{ $cat->name }}">
                        @endif
                ...
                <div class="col-sm-2 text-center mt-3">
                    <a href="{{ url('/shop') }}/{{$category->slug}}">
                        ...
                        @else
                            <img loading="lazy" src="https://dummyimage.com/100x100/e5e8ec/333333&text={{ urlencode($category->name) }}" alt="{{ $category->name }}">
                        @endif
                        <h3 class="product-name mr-3 ml-3 mt-3 mb-3">
                            {{ $category->name }}
                        </h3>
