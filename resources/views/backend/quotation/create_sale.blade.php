...
<script type="text/javascript">
    ...
    if(!$('input[name="order_discount_value"]').val())
        $('input[name="order_discount_value"]').val('{{number_format(0, gen_setting()->decimal, '.', '')}}');
    $('#order_discount').text(parseFloat($('input[name="order_discount_value"]').val()).toFixed({{gen_setting()->decimal}}));
    ...
    function calculateGrandTotal() {
        ...
        if( $('select[name="payment_status"]').val() == 4 ){
            $('#paying-amount').val('');
            $('#paid-amount').val(grand_total.toFixed({{gen_setting()->decimal}}));
        }
