                                            ...
                                            <table id="myTable" class="table table-hover order-list">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="net_unit_cost">{{ number_format((float)$net_unit_cost, gen_setting()->decimal, '.', '')}} </td>
                                                        <td class="discount">{{ number_format((float)$product_quotation->discount, gen_setting()->decimal, '.', '')}}</td>
                                                        <td class="tax">{{ number_format((float)$tax, gen_setting()->decimal, '.', '')}}</td>
                                                        <td class="sub-total">{{ number_format((float)$sub_total, gen_setting()->decimal, '.', '')}}</td>
                                                ...
                                                <tfoot class="tfoot active">
                                                    ...
                                                    <th id="total">{{ number_format((float)$lims_quotation_data->total_cost, gen_setting()->decimal, '.', '')}}</th>
                                                    <th><i class="ti ti-trash"></i></th>
                                                </tfoot>
                                            </table>
                                        </div>
