...
<section>
    <div class="container-fluid">
        ...
        @if(in_array("quotes-add", $all_permission))
            <a href="{{route('quotations.create')}}" class="btn btn-info"><i class="ti ti-plus"></i> {{__('db.Add Quotation')}}</a>&nbsp;
        @endif
    </div>
        ...
        <div class="container mt-3 pb-2 border-bottom">
            <div class="row">
                <div class="col-md-6 d-print-none">
                    ...
                    <form action="{{ route('quotation.sendmail') }}" method="post" class="sendmail-form">
                        @csrf
                ...
                <div class="col-md-12 text-center">
                    <img src="{{url('logo', gen_setting()->site_logo)}}" height="70" width="120">
                </div>
                <div class="col-md-12 text-center">
