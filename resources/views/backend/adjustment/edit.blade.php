            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('qty_adjustment.update', $lims_adjustment_data->id) }}" method="post" enctype="multipart/form-data" id="adjustment-form">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-md-4">
		...
		$.ajax({
            ...
            success: function(data) {
                ...
                if(flag){
                    ...
                    cols += '<td>' + data[0] + '</td>';
                    cols += '<td>' + data[1] + '</td>';
                    cols += '<td>' + data[2] + '<input type="hidden" name="unit_cost[]" value="'+data[2]+'" /></td>';
