<ul id="side-main-menu" class="side-menu list-unstyled">
    ...
    <li>
        ...
        <ul id="delivery-management" class="collapse list-unstyled">
            ...
            <li id="delivery-sale-return-menu"><a class="{{ request()->is('delivery-return') ? 'active' : '' }}" href="{{route('delivery-return.index')}}">{{ __('db.Sale Return') }}</a></li>
            @endcan
            @can('delivery-sales-sale-exchange')
            <li id="delivery-sale-exchange-menu"><a class="{{ request()->is('delivery-exchange') ? 'active' : '' }}" href="{{route('delivery-exchange.index')}}">{{ __('db.Sale Exchange') }}</a></li>
            @endcan
            @endif
        </ul>
    </li>
