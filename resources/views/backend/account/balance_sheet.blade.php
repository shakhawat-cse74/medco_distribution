        ...
        <table id="account-table" class="table table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{number_format((float)$credit[$key], gen_setting()->decimal, '.', '')}}</td>
                    <td>{{number_format((float)($debit[$key] * -1), gen_setting()->decimal, '.', '')}}</td>
                    <td>{{number_format((float)($credit[$key] - $debit[$key]), gen_setting()->decimal, '.', '')}}</td>
                </tr>
                @endforeach
            </tbody>
