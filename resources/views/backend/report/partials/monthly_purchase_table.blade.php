<div class="table-responsive mt-4">
    <table class="table table-bordered" style="border-top: 1px solid #dee2e6; border-bottom: 1px solid #dee2e6;">
        <thead>
            <tr>
                <th><a href="{{url('report/monthly_purchase/'.($year-1))}}"><i class="ti ti-arrow-left"></i> {{__('db.Previous')}}</a></th>
                <th colspan="10" class="text-center">{{$year}}</th>
                <th><a href="{{url('report/monthly_purchase/'.($year+1))}}">{{__('db.Next')}} <i class="ti ti-arrow-right"></i></a></th>
            </tr>
        </thead>
        <tbody>
            <tr>
