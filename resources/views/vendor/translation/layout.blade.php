...
<head>
    ...
    <link rel="stylesheet" href="{{ asset($asset_prefix . 'vendor/bootstrap/css/awesome-bootstrap-checkbox.css') }}"
          type="text/css">
    <link rel="stylesheet" href="{{ asset($asset_prefix . 'vendor/bootstrap-toggle/css/bootstrap-toggle.min.css') }}"
          type="text/css">
    <link rel="stylesheet" href="{{ asset($asset_prefix . 'vendor/bootstrap/css/bootstrap-datepicker.min.css') }}"
          type="text/css">

    <link rel="stylesheet" href="{{ asset($asset_prefix . 'vendor/jquery-clockpicker/bootstrap-clockpicker.min.css') }}"
          type="text/css">
    <!-- Boostrap Tag Inputs-->
    <link rel="stylesheet" href="{{ asset($asset_prefix . 'vendor/Tag_input/tagsinput.css') }}" type="text/css">

    <link rel="stylesheet" href="{{ asset($asset_prefix . 'vendor/bootstrap/css/bootstrap-select.min.css') }}"
          type="text/css">
    <!-- Font Awesome CSS-->
    <link rel="stylesheet" href="{{ asset($asset_prefix . 'vendor/font-awesome/css/font-awesome.min.css') }}"
          type="text/css">
    <!-- ti ti icon font-->
    <link rel="stylesheet" href="{{ asset($asset_prefix . 'vendor/ti ti/webfont.css') }}" type="text/css">
    <!-- Google fonts - Roboto -->
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Roboto:300,400,700">
    <!-- jQuery Circle-->
    <link rel="stylesheet" href="{{ asset($asset_prefix . 'css/grasp_mobile_progress_circle-1.0.0.min.css') }}" type="text/css">
    <!-- Custom Scrollbar-->
    <link rel="stylesheet" href="{{ asset($asset_prefix . 'vendor/malihu-custom-scrollbar-plugin/jquery.mCustomScrollbar.css') }}" type="text/css">
    <!-- date range stylesheet-->
    <link rel="stylesheet" href="{{ asset($asset_prefix . 'vendor/daterange/css/daterangepicker.min.css') }}"
          type="text/css">
    <!-- table sorter stylesheet-->
    <link rel="stylesheet" type="text/css"
          href="{{ asset($asset_prefix . 'vendor/datatable/dataTables.bootstrap4.min.css') }}">
    <link rel="stylesheet" type="text/css"
          href="{{ asset($asset_prefix . 'vendor/datatable/buttons.bootstrap4.min.css') }}">
    <link rel="stylesheet" type="text/css"
          href="{{ asset($asset_prefix . 'vendor/datatable/select.bootstrap4.min.css') }}">
    <link rel="stylesheet" type="text/css"
          href="{{ asset($asset_prefix . 'vendor/datatable/dataTables.checkboxes.css') }}">
    <link rel="stylesheet" type="text/css"
          href="{{ asset($asset_prefix . 'vendor/datatable/datatables.flexheader.boostrap.min.css') }}">

    <link rel="stylesheet" type="text/css"
          href="{{ asset($asset_prefix . 'vendor/select2/dist/css/select2.min.css') }}">

    <link rel="stylesheet" type="text/css"
          href="{{ asset($asset_prefix . 'vendor/RangeSlider/ion.rangeSlider.min.css') }}">

    <link rel="stylesheet" type="text/css"
          href="{{ asset($asset_prefix . 'vendor/datatable/datatable.responsive.boostrap.min.css') }}">
    <!-- theme stylesheet-->
    <link rel="stylesheet" href="{{ asset($asset_prefix . 'css/style.default.css') }}" id="theme-stylesheet"
          type="text/css">

    <link rel="stylesheet" href="{{ asset($asset_prefix . 'vendor/translation/css/main.css') }}">
    ...
    <script type="text/javascript"
            src="{{ asset($asset_prefix . 'vendor/jquery/bootstrap-datepicker.min.js') }}"></script>

    <script type="text/javascript"
            src="{{ asset($asset_prefix . 'vendor/jquery-clockpicker/bootstrap-clockpicker.min.js') }}"></script>
    ...
    <script type="text/javascript"
            src="{{ asset($asset_prefix . 'vendor/bootstrap-toggle/js/bootstrap-toggle.min.js') }}"></script>
    <script type="text/javascript"
            src="{{ asset($asset_prefix . 'vendor/bootstrap/js/bootstrap-select.min.js') }}"></script>

    <script type="text/javascript"
            src="{{ asset($asset_prefix . 'js/grasp_mobile_progress_circle-1.0.0.min.js') }}"></script>

    <script type="text/javascript" src="{{ asset($asset_prefix . 'vendor/chart.js/Chart.min.js') }}"></script>
    <script type="text/javascript"
            src="{{ asset($asset_prefix . 'vendor/jquery-validation/jquery.validate.min.js') }}"></script>
    <script type="text/javascript"
            src="{{ asset($asset_prefix . 'vendor/malihu-custom-scrollbar-plugin/jquery.mCustomScrollbar.concat.min.js')}}"></script>
    ...
    <script type="text/javascript"
            src="{{ asset($asset_prefix . 'vendor/daterange/js/daterangepicker.min.js') }}"></script>
    <script type="text/javascript"
            src="{{ asset($asset_prefix . 'vendor/tinymce/js/tinymce/tinymce.min.js') }}"></script>

    <!-- JS for Boostrap Tag Inputs-->

    <script type="text/javascript" src="{{ asset($asset_prefix . 'vendor/Tag_input/tagsinput.js') }}"></script>

    <script type="text/javascript"
            src="{{ asset($asset_prefix . 'vendor/RangeSlider/ion.rangeSlider.min.js') }}"></script>
    ...
    <script type="text/javascript"
            src="{{ asset($asset_prefix . 'vendor/datatable/jquery.dataTables.min.js') }}"></script>
    <script type="text/javascript"
            src="{{ asset($asset_prefix . 'vendor/datatable/dataTables.bootstrap4.min.js') }}"></script>
    <script type="text/javascript"
            src="{{ asset($asset_prefix . 'vendor/datatable/dataTables.buttons.min.js') }}"></script>
    <script type="text/javascript"
            src="{{ asset($asset_prefix . 'vendor/datatable/buttons.bootstrap4.min.js') }}"></script>
    ...
    <script type="text/javascript" src="{{ asset($asset_prefix . 'vendor/datatable/buttons.print.min.js') }}"></script>
    <script type="text/javascript"
            src="{{ asset($asset_prefix . 'vendor/datatable/dataTables.select.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset($asset_prefix . 'vendor/datatable/sum().js') }}"></script>
    <script type="text/javascript"
            src="{{ asset($asset_prefix . 'vendor/datatable/dataTables.checkboxes.min.js') }}"></script>
    <script type="text/javascript"
            src="{{ asset($asset_prefix . 'vendor/datatable/datatable.fixedheader.min.js') }}"></script>
    <script type="text/javascript"
            src="{{ asset($asset_prefix . 'vendor/datatable/datatable.responsive.min.js') }}"></script>
    <script type="text/javascript"
            src="{{ asset($asset_prefix . 'vendor/select2/dist/js/select2.min.js') }}"></script>
    <script type="text/javascript"
            src="{{ asset($asset_prefix . 'vendor/datatable/datatable.responsive.boostrap.min.js') }}"></script>
    <style type="text/css">
        svg{width:20px;}
    </style>
</head>
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-holder d-flex align-items-center justify-content-between">
                <a id="toggle-btn" href="#" class="menu-btn"><i class="ti ti-menu"> </i></a>
                ...
                <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                    <li class="nav-item"><a id="btnFullscreen" href="" data-toggle="tooltip" title="{{__('Full Screen')}}"><i class="ti ti-arrows-maximize"></i></a></li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a rel="nofollow" href="#" class="nav-link dropdown-item">
                            <i class="ti ti-world"></i> <span>{{__('Language')}}</span>
                        </a>
                        <ul class="right-sidebar">
                        ...
                        <ul class="right-sidebar">
                            ...
                            <li>
                                <form id="logout-form" action="{{ route('logout') }}" method="POST">
                                    @csrf
                                    <button class="btn btn-link" type="submit"><i class="ti ti-exit"></i> {{__('db.logout')}}</button>
                                </form>
                            </li>
                        </ul>
                    </li>
            ...
            <ul id="side-main-menu" class="side-menu list-unstyled">
                @if(auth()->user()->role_users_id ==1)
                    <li class="{{ (request()->is('admin/dashboard*')) ? 'active' : '' }}"><a
                                href="{{url('/admin/dashboard')}}"> <i
                                    class="ti ti-meter"></i><span>{{__('db.Dashboard')}}</span></a>
                    </li>
                @else
                ...
                @can('view-details-employee')
                    <li class="has-dropdown {{ (request()->is('staff*')) ? 'active' : '' }}">
                        <a href="#employees" aria-expanded="false" data-toggle="collapse"> <i class="ti ti-user-group"></i><span>{{__('db.Employees')}}</span></a>
                    ...
                    <li class="has-dropdown {{ (request()->is('settings*')) ? 'active' : '' }}">
                        ...
                        @if(auth()->user()->can('view-role')||auth()->user()->can('view-general-setting')||auth()->user()->can('access-language')||auth()->user()->can('access-variable_type')||auth()->user()->can('access-variable_method')||auth()->user()->can('view-general-setting'))
                            <a href="#Customize_settings" aria-expanded="false" data-toggle="collapse">
                                <i class="ti ti-toggles"></i><span>{{__('Customize Setting')}}</span>
                            </a>
                        @endif
                        {{-- <a href="#Customize_settings" aria-expanded="false" data-toggle="collapse">
                            <i class="ti ti-toggles"></i><span>{{__('Customize Setting')}}</span>
                    ...
                    <li class="has-dropdown {{ (request()->is('core_hr*')) ? 'active' : '' }}">
                        ...
                        @if(auth()->user()->can('view-promotion')||auth()->user()->can('view-award') || auth()->user()->can('view-travel')||auth()->user()->can('view-transfer')||auth()->user()->can('view-resignation')||auth()->user()->can('view-complaint')||auth()->user()->can('view-warning')||auth()->user()->can('view-termination'))
                            <a href="#Core_hr" aria-expanded="false" data-toggle="collapse">
                                <i class="ti ti-briefcase"></i><span>{{__('Core HR')}}</span>
                            </a>
                        @endcan
                ...
                <li class="has-dropdown {{ (request()->is('organization*')) ? 'active' : '' }}"><a href="#Organization"
                        ...
                        <i
                                class="ti ti-view-thumb"></i><span>{{__('db.Organization')}}</span></a>
                    <ul id="Organization" class="collapse list-unstyled ">
                        ...
                        @can('view-location')
                            <li id="location"><a href="{{route('locations.index')}}">{{__('db.Warehouse')}}</a></li>
                        @endcan
                ...
                @can('timesheet')
                    <li class="has-dropdown {{ (request()->is('timesheet*')) ? 'active' : '' }}"><a href="#Timesheets"
                                                                                                    aria-expanded="false"
                                                                                                    data-toggle="collapse">
                            <i class="ti ti-clock"></i><span>{{__('db.Timesheets')}}</span></a>
                    ...
                    <li class="has-dropdown {{ (request()->is('payroll*')) ? 'active' : '' }}">
                        ...
                        @if(auth()->user()->can('view-payslip') || auth()->user()->can('view-paylist'))
                            <a href="#Payroll" aria-expanded="false" data-toggle="collapse">
                                <i class="ti ti-wallet"></i><span>{{__('db.Payroll')}}</span>
                            </a>
                        @endif
                ...
                @can('performance')
                        <li class="has-dropdown {{ (request()->is('performance*')) ? 'active' : '' }}">
                            @if(auth()->user()->can('view-goal-type') || auth()->user()->can('view-goal-tracking') || auth()->user()->can('view-indicator') || auth()->user()->can('view-appraisal'))
                                <a href="#performance" aria-expanded="false" data-toggle="collapse"> <i class="ti ti-bar-chart"></i>
                ...
                @can('view-calendar')
                    <li class="{{ (request()->is('calendar*')) ? 'active' : '' }}"><a
                                href="{{route('calendar.index')}}"> <i
                                    class="ti ti-calendar"></i><span>{{__('HR Calendar')}}</span></a>
                    </li>
                @endcan
                ...
                {{-- @can('hr_report') --}}
                    <li class="has-dropdown {{ (request()->is('report*')) ? 'active' : '' }}"><a href="#HR_Reports"
                                                                                                 aria-expanded="false"
                                                                                                 data-toggle="collapse">
                            <i class="ti ti-document"></i><span>{{__('HR Reports')}}</span></a>
                    ...
                    <li class="has-dropdown {{ (request()->is('recruitment*')) ? 'active' : '' }}">
                        ...
                        @if(auth()->user()->can('view-job_post') || auth()->user()->can('view-job_candidate')|| auth()->user()->can('view-job_interview') || auth()->user()->can('view-cms'))
                            <a href="#Recruitment" aria-expanded="false" data-toggle="collapse">
                                <i class="ti ti-user-id"></i><span>{{__('db.Recruitment')}}</span>
                            </a>
                        @endif
                    ...
                    <li class="has-dropdown @if(request()->is('training*')){{ (request()->is('training*')) ? 'active' : '' }}@elseif(request()->is('dynamic_variable/training_type*')){{ (request()->is('dynamic_variable/training_type*')) ? 'active' : '' }}@endif">
                        @if(auth()->user()->can('view-training') || auth()->user()->can('access-variable_type')|| auth()->user()->can('access-trainer'))
                            <a href="#Training" aria-expanded="false" data-toggle="collapse"> <i
                                        class="ti ti-trophy"></i><span>{{__('db.Training')}}</span>
                            </a>
                        @endcan
                    ...
                    <li class="has-dropdown @if(request()->is('events*')){{ (request()->is('events*')) ? 'active' : '' }}@elseif(request()->is('meetings*')){{ (request()->is('meetings*')) ? 'active' : '' }}@endif">
                        ...
                        @if(auth()->user()->can('view-event') || auth()->user()->can('view-meeting'))
                            <a href="#Events_Meetings" aria-expanded="false" data-toggle="collapse"> <i
                                        class="ti ti-to-do"></i><span>{{__('db.Events')}} & {{__('db.Meetings')}}</span>
                            </a>
                        @endcan
                        ...
                        <li class="has-dropdown {{ (request()->is('project-management*')) ? 'active' : '' }}">
                            @if(auth()->user()->can('view-project') || auth()->user()->can('view-task') || auth()->user()->can('client') || auth()->user()->can('view-invoice'))
                                <a href="#Project_Management" aria-expanded="false" data-toggle="collapse">
                                    <i class="ti ti-checklist"></i><span>{{__('Project Management')}}</span>
                                </a>
                            @endcan
                    ...
                    @can('view-ticket')
                        <li class="{{ (request()->is('tickets*')) ? 'active' : '' }}">
                                <a href="{{route('tickets.index')}}"> <i
                                            class="ti ti-ticket"></i><span>{{__('Support Tickets')}}</span>
                                </a>
                        </li>
                    @endcan
                    @can('finance')
                        <li class="has-dropdown {{ (request()->is('accounting*')) ? 'active' : '' }}">
                            ...
                            @if(auth()->user()->can('view-account') || auth()->user()->can('view-payee') || auth()->user()->can('view-payer') ||auth()->user()->can('view-deposit')||auth()->user()->can('view-expense')||auth()->user()->can('view-transaction')||auth()->user()->can('view-balance_transfer'))
                                <a href="#Finance" aria-expanded="false" data-toggle="collapse">
                                    <i class="ti ti-graph-pie"></i><span>{{__('db.Finance')}}</span>
                                </a>
                            @endcan
                        ...
                        <li class="has-dropdown @if(request()->is('assets*')){{ (request()->is('assets*')) ? 'active' : '' }}@elseif(request()->is('dynamic_variable/assets_category*')){{ (request()->is('dynamic_variable/assets_category*')) ? 'active' : '' }}@endif">
                            @if(auth()->user()->can('category') || auth()->user()->can('assets'))
                                <a href="#assets" aria-expanded="false" data-toggle="collapse"> <i
                                            class="ti ti-box"></i><span>{{trans(('file.Assets'))}}</span>
                                </a>
                            @endcan
                        ...
                        <li class="has-dropdown {{ (request()->is('file_manager*')) ? 'active' : '' }}">
                            ...
                            @if(auth()->user()->can('view-file_manager') || auth()->user()->can('view-official_documents'))
                                <a href="#file_manager" aria-expanded="false" data-toggle="collapse"> <i
                                            class="ti ti-archive"></i><span>{{__('File Manager')}}</span>
                                </a>
                            @endcan
...
<script src="{{ asset($asset_prefix . 'vendor/translation/js/app.js') }}"></script>
