                                ...
                                @if(!is_array($value[config('app.locale')]))
                                    <tr>
                                        ...
                                        <td class="d-flex">
                                            ...
                                            <button class="update_btn btn btn-primary btn-sm" style="display: none;" type="button" data-key="{{ $key }}" data-language="{{ $language }}" data-group="{{ $group }}" title="Update"><i class="ti ti-edit" aria-hidden="true"></i></button><br>
                                            <button class="check_icon btn btn-success btn-sm" style="display: none;"><i class="ti ti-checkmark" aria-hidden="true"></i></button>
                                        </td>
                                    </tr>
                                @endif
                            @endforeach
