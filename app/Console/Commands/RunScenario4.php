...
class RunScenario4 extends Command
{
    protected $signature = 'test:scenario4';
    protected $description = 'Run Scenario 4: Create a sale with partial payment';
    ...
    public function handle()
    {
        ...
        $postData = [
            ...
            'paid_by_id' => [1], // Cash
            'payment_note' => 'Scenario 4 POS Partial Payment',
        ...
        // Verify Customer Due (since partially paid, due should increase by $total - $paid)
        ...
        $expectedRegisterPaymentTotal = Payment::where('cash_register_id', $register->id)->where('id', '!=', Payment::latest()->first()->id)->sum('amount') + $paid;
